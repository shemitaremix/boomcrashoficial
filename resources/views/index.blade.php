                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="assets/images/description-1.png" alt="BOOMCRASH">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="assets/images/description-2.png" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img class="img-fluid" src="assets/images/description-3.png" alt="alternative">
                        </div>
                        <div class="card-body">
                    ...
                    <div class="tab-content" id="argoTabsContent">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image-container">
                                        <img class="img-fluid" src="assets/images/features-1.png" alt="alternative">
                        ...
                        <div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image-container">
                                        <img class="img-fluid" src="assets/images/features-2.png" alt="alternative">
                                    </div> <!-- end of image-container -->
                                </div> <!-- end of col -->
                                <div class="col-lg-6">
                                    <div class="text-container">
